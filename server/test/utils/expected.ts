...
export const pipelineFiles = {
  bad: getPath("./pipelines/bad_pipeline.yml"),
  completion: getPath("./pipelines/completion_pipeline.yml"),
  emptyNodeList: getPath("./pipelines/empty_node_list_pipeline.yml"),
  good: getPath("./pipelines/good_pipeline.yml"),
  invalid: getPath("./pipelines/invalid_pipeline.yml"),
  invalidConfigKey: getPath("./pipelines/invalid_config_key_pipeline.yml"),
  missingNodesKey: getPath("./pipelines/missing_nodes_key_pipeline.yml"),
  multipleNodeEntry: getPath("./pipelines/multiple_node_entry_pipeline.yml"),
  multipleTopKeys: getPath("./pipelines/multiple_top_keys_pipeline.yml"),
  valid: getPath("./pipelines/valid_pipeline.yml"),
};
